...
see the [`LICENSE`](https://github.com/CodeEditorLand/Rest/tree/Current/LICENSE) file.
...
[`CHANGELOG.md`](https://github.com/CodeEditorLand/Rest/tree/Current/CHANGELOG.md) for a
