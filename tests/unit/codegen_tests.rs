...
fn test_codegen_simple_expression() {
    ...
    assert!(output.contains("const x") && output.contains("42"),
...
fn test_codegen_function() {
    ...
    assert!(output.contains("function add") || output.contains("add"),
...
fn test_codegen_arrow_functions() {
    ...
    assert!(output.contains("add") && output.contains("square"),
...
fn test_codegen_template_literals() {
    ...
    assert!(output.contains("`Hello, ${name}!`") || output.contains("Hello") && output.contains("name"),
...
fn test_codegen_spread_operator() {
    ...
    assert!(output.contains("arr1") && output.contains("arr2"),
...
fn test_codegen_optional_chaining() {
    ...
    assert!(output.contains("?.=") || output.contains("?.") || output.contains("obj"),
...
fn test_codegen_async_await() {
    ...
    assert!(output.contains("async") || output.contains("function fetchData"),
...
fn test_codegen_generators() {
    ...
    assert!(output.contains("*") && output.contains("yield"),
...
fn test_codegen_big_int() {
    ...
    assert!(output.contains("9007199254740991n") || output.contains("bigint"),
...
fn test_codegen_regular_expressions() {
    ...
    assert!(output.contains("/hello/") || output.contains("RegExp"),
...
fn test_codegen_throw_expressions() {
    ...
    assert!(output.contains("throw") || output.contains("Error"),
...
fn test_codegen_assertions() {
    ...
    assert!(output.contains("elem") || output.contains("getElementById"),
...
fn test_codegen_satisfies() {
    ...
    assert!(output.contains("obj") || output.contains("a: 1"),
...
fn test_codegen_variadic_tuples() {
    ...
    assert!(output.contains("tuple") || output.contains("..."),
...
fn test_codegen_this_types() {
    ...
    assert!(output.contains("getThis") && output.contains("this"),
...
fn test_codegen_labeled_statements() {
    ...
    assert!(output.contains("outer:") || output.contains("break outer"),
...
fn test_codegen_switch_expressions() {
    ...
    assert!(result.is_ok() || result.is_err(), "Switch expressions may or may not be supported yet");
}
...
fn test_codegen_function_let_binding() {
    ...
    assert!(output.contains("function") || output.contains("arrow"),
...
fn test_codegen_complex_expressions() {
    ...
    assert!(output.contains("obj") && output.contains("arr"),
...
fn test_codegen_export_star() {
    ...
    assert!(output.contains("export") && output.contains("from"),
...
fn test_codegen_import_type() {
    ...
    assert!(output.is_empty() || !output.contains("import type"),
...
fn test_codegen_declare_merge() {
    ...
    assert!(output.contains("staticValue") || output.contains("42"),
...
fn test_codegen_intl_constructs() {
    ...
    assert!(output.contains("Intl") || output.contains("DateTimeFormat"),
...
fn test_codegen_map_set() {
    ...
    assert!(output.contains("Map") && output.contains("Set"),
...
fn test_codegen_typed_arrays() {
    ...
    assert!(output.contains("ArrayBuffer") || output.contains("Int32"),
...
fn test_codegen_generator_delegation() {
    ...
    assert!(output.contains("yield*") || output.contains("yield"),
...
fn test_codegen_await_generator() {
    ...
    assert!(output.contains("async") && output.contains("*") && output.contains("yield"),
...
fn test_codegen_object_literal_methods() {
    ...
    assert!(output.contains("method") || output.contains("accessor"),
...
fn test_codegen_computed_properties() {
    ...
    assert!(output.contains("[") && output.contains("key"),
...
fn test_codegen_object_spread() {
    ...
    assert!(output.contains("{ ...obj1") || output.contains("...obj1"),
...
fn test_codegen_array_spread() {
    ...
    assert!(output.contains("...arr") || output.contains("combined"),
...
fn test_codegen_optional_elements() {
    ...
    assert!(output.contains("arr") || output.contains("1") && output.contains("3"),
...
fn test_codegen_shorthand_properties() {
    ...
    assert!(output.contains("x") && output.contains("obj"),
...
fn test_codegen_function_parameter_properties() {
    ...
    assert!(output.contains("process") && output.contains("a") && output.contains("b"),
...
fn test_codegen_rest_parameters() {
    ...
    assert!(output.contains("...nums") || output.contains("nums"),
...
fn test_codegen_default_parameters() {
    ...
    assert!(output.contains("World") || output.contains("'World'"),
...
fn test_codegen_typecast_expressions() {
    ...
    assert!(output.contains("x") && output.contains("someValue"),
...
fn test_codegen_non_null_assertion() {
    ...
    assert!(output.contains("value") || output.contains("maybeNull"),
...
fn test_codegen_optional_chaining_assignment() {
    ...
    assert!(output.contains("?") || output.contains("obj"),
...
fn test_codegen_pipeline_operator() {
    ...
    assert!(result.is_ok() || result.is_err(), "Pipeline operator may not be fully supported yet");
    if let Ok(output) = result {
        assert!(output.contains("|>") || output.contains("transform"),
...
fn test_codegen_function_bind_operator() {
    ...
    assert!(result.is_ok() || result.is_err(), "Function bind operator may not be fully supported yet");
}
...
fn test_codegen_numeric_separator() {
    ...
    assert!(output.contains("000") || output.contains("1_000_000"),
...
fn test_codegen_decorator_metadata() {
    ...
    assert!(output.contains("__decorate") || output.contains("Component") ||
...
fn test_codegen_class_decorators() {
    ...
    assert!(output.contains("DecoratedClass") || output.contains("sealed"),
...
fn test_codegen_method_decorators() {
    ...
    assert!(output.contains("method") || output.contains("readonly"),
...
fn test_codegen_accessor_decorators() {
    ...
    assert!(output.contains("value") || output.contains("get") || output.contains("set"),
...
fn test_codegen_parameter_decorators() {
    ...
    assert!(output.contains("method") || output.contains("param"),
