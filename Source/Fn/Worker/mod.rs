...
//!
//! Provides worker-file detection and classification, bootstrap code
//! generation, and module handling for worker contexts.
//!
//! ## Modules
//!
//! * [`Detect`] — Worker-file detection and classification.
//! * [`Bootstrap`] — Bootstrap code generation for workers.
//! * [`Compile`] — Worker compilation orchestration.
...
pub struct WorkerConfig {
	...
	/// Additional scripts to include in the worker bootstrap.
...
impl WorkerConfig {
	/// Creates a new [`WorkerConfig`] with default settings.
	pub fn new() -> Self {
		Self {
			enabled:true,
...
impl WorkerType {
	/// Returns the worker type as a static string identifier.
...
impl WorkerInfo {
	/// Creates a new [`WorkerInfo`] for the given source path and type.
